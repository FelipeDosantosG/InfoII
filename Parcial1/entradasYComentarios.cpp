    ...
    cout << "El número ingresado no es impar. Por avor, intente de nuevo con un número impar." << endl;
    return 1;
    } Esta es una validación que se asegura que los datos sean impares.*/
